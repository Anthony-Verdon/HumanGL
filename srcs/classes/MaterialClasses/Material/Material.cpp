...
MaterialParsingFunctions Material::parsingFunctions = {
    {"Ka", &Material::defineAmbiantColor},    {"Ks", &Material::defineSpecularColor},
    {"Kd", &Material::defineDiffuseColor},    {"Ns", &Material::defineSpecularExponent},
    {"Ni", &Material::defineRefractionIndex}, {"d", &Material::defineOpacity},
