...
//             rotation = Matrix::rotate(rotation, angleX, Matrix::normalize(axisX)) *
//                        Matrix::rotate(rotation, angleY, Matrix::normalize(axisY)) *
//                        Matrix::rotate(rotation, angleZ, Matrix::normalize(axisZ));
