...
TEST_CASE("test the definition of an object")
{
    ...
    {
        CHECK_NOTHROW(ObjectParser::parseObjectFile("srcs/tester/ressources/object.obj"));
        CHECK_NOTHROW(ObjectParser::parseObjectFile("srcs/tester/ressources/..obj"));
    ...
    {
        CHECK_NOTHROW(ObjectParser::parseObjectFile("srcs/tester/ressources/object.obj"));
        CHECK_THROWS(ObjectParser::parseObjectFile("srcs/tester/ressources/objectWrongSymbol.obj"));
    }
    ...
    {
        objectData.reset();
        CHECK_NOTHROW(ObjectParser::saveNewMTL(objectData, "mtllib srcs/tester/ressources/material.mtl", 0));
    ...
    {
        objectData.reset();
        ObjectParser::saveNewMTL(objectData, "objectData,mtllib srcs/tester/ressources/material.mtl", 0);
...
TEST_CASE("test the definition of a material")
{
    SUBCASE("testing the parsing of a file with an invalid extension")
    {
        ...
        CHECK_NOTHROW(MaterialParser::parseMaterialFile("srcs/tester/ressources/..mtl"));
